...
exports.compileCPPWithInput = function ( envData , code , input ,  fn ) {
	...
	if(fs.existsSync(path+inputfile)) fs.unlinkSync(path+inputfile);					
	if(fs.existsSync(path+filename+".cpp")) fs.unlinkSync(path+filename+".cpp");
